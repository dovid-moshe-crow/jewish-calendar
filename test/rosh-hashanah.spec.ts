...
describe('RoshHashanah', () => {
  describe('constructor', () => {
    test('should create a valid RoshHashanah object', () => {
      const roshHashanah = new RoshHashanah(5784);
  ...
  describe('getWeekDay', () => {
    ...
    test('should return the correct week day for 5785', () => {
      const roshHashanah = new RoshHashanah(5785);

      //expect(roshHashanah.getWeekDay()).toBe(5);

      expect(roshHashanah.getMolad().toString()).toBe('6 18:00');
    });
  });
});
